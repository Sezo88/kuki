...
var FALLBACK_BASE = "https://www.fullhdfilmizlesene.live";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["fullhdfilmizlesene"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[fullhdfilmizlesene] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[fullhdfilmizlesene] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "fullhdfilmizlesene");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*fullhdfilmizlesene[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "fullhdfilmizlesene");
      });
    });
  }).catch(function(err) {
    console.error("[fullhdfilmizlesene] Hata:", err.message);
    return [];
  });
}
