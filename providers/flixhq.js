...
var FALLBACK_BASE = "https://flixhq.to";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["flixhq"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[flixhq] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[flixhq] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "flixhq");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*flixhq[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "flixhq");
      });
    });
  }).catch(function(err) {
    console.error("[flixhq] Hata:", err.message);
    return [];
  });
}
