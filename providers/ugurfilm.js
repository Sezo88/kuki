...
var FALLBACK_BASE = "https://ugurfilm.biz";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["ugurfilm"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[ugurfilm] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[ugurfilm] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "ugurfilm");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*ugurfilm[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "ugurfilm");
      });
    });
  }).catch(function(err) {
    console.error("[ugurfilm] Hata:", err.message);
    return [];
  });
}
