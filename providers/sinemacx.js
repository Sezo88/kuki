...
var FALLBACK_BASE = "https://www.sinemacx.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["sinemacx"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[sinemacx] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[sinemacx] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "sinemacx");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*sinemacx[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "sinemacx");
      });
    });
  }).catch(function(err) {
    console.error("[sinemacx] Hata:", err.message);
    return [];
  });
}
