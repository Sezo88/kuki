...
var FALLBACK_BASE = "https://www.kick.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["kicktr"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[kicktr] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[kicktr] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "kicktr");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*kicktr[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "kicktr");
      });
    });
  }).catch(function(err) {
    console.error("[kicktr] Hata:", err.message);
    return [];
  });
}
