...
var FALLBACK_BASE = "https://www.hdfilmizle.sbs";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["hdfilmizle"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[hdfilmizle] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[hdfilmizle] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "hdfilmizle");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*hdfilmizle[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "hdfilmizle");
      });
    });
  }).catch(function(err) {
    console.error("[hdfilmizle] Hata:", err.message);
    return [];
  });
}
