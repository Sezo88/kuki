...
var FALLBACK_BASE = "https://www.diziasya.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["diziasya"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[diziasya] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[diziasya] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "diziasya");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*diziasya[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "diziasya");
      });
    });
  }).catch(function(err) {
    console.error("[diziasya] Hata:", err.message);
    return [];
  });
}
