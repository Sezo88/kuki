...
var FALLBACK_BASE = "https://www.koreanturk.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["koreanturk"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[koreanturk] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[koreanturk] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "koreanturk");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*koreanturk[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "koreanturk");
      });
    });
  }).catch(function(err) {
    console.error("[koreanturk] Hata:", err.message);
    return [];
  });
}
