// webteleizle Provider for Nuvio
...
var FALLBACK_BASE = "https://www.webteizle.pro";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["webteleizle"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[webteleizle] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[webteleizle] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "webteleizle");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*webteleizle[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "webteleizle");
      });
    });
  }).catch(function(err) {
    console.error("[webteleizle] Hata:", err.message);
    return [];
  });
}
