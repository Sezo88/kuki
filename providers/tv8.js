...
var FALLBACK_BASE = "https://www.tv8.com.tr";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["tv8"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[tv8] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[tv8] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "tv8");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*tv8[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "tv8");
      });
    });
  }).catch(function(err) {
    console.error("[tv8] Hata:", err.message);
    return [];
  });
}
