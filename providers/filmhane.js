...
var FALLBACK_BASE = "https://www.filmhane.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["filmhane"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[filmhane] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[filmhane] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "filmhane");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*filmhane[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "filmhane");
      });
    });
  }).catch(function(err) {
    console.error("[filmhane] Hata:", err.message);
    return [];
  });
}
