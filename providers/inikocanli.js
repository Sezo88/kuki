...
var FALLBACK_BASE = "https://www.ginikocanli.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["inikocanli"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[inikocanli] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[inikocanli] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "inikocanli");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*inikocanli[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "inikocanli");
      });
    });
  }).catch(function(err) {
    console.error("[inikocanli] Hata:", err.message);
    return [];
  });
}
