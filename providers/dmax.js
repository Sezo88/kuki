...
var FALLBACK_BASE = "https://www.dmax.com.tr";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["dmax"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[dmax] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[dmax] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "dmax");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*dmax[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "dmax");
      });
    });
  }).catch(function(err) {
    console.error("[dmax] Hata:", err.message);
    return [];
  });
}
