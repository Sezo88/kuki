...
var FALLBACK_BASE = "https://www.teve2.com.tr";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["teve2"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[teve2] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[teve2] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "teve2");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*teve2[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "teve2");
      });
    });
  }).catch(function(err) {
    console.error("[teve2] Hata:", err.message);
    return [];
  });
}
