...
var FALLBACK_BASE = "https://dizist.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["dizist"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[dizist] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[dizist] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "dizist");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*dizist[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "dizist");
      });
    });
  }).catch(function(err) {
    console.error("[dizist] Hata:", err.message);
    return [];
  });
}
