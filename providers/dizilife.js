...
var FALLBACK_BASE = "https://dizilife.me";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["dizilife"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[dizilife] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[dizilife] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "dizilife");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*dizilife[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "dizilife");
      });
    });
  }).catch(function(err) {
    console.error("[dizilife] Hata:", err.message);
    return [];
  });
}
