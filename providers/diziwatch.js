...
var FALLBACK_BASE = "https://www.diziwatch.net";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["diziwatch"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[diziwatch] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[diziwatch] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "diziwatch");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*diziwatch[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "diziwatch");
      });
    });
  }).catch(function(err) {
    console.error("[diziwatch] Hata:", err.message);
    return [];
  });
}
