// mirrorverse Provider for Nuvio
...
var FALLBACK_BASE = "https://mirrorverse.xyz";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["mirrorverse"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[mirrorverse] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[mirrorverse] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "mirrorverse");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*mirrorverse[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "mirrorverse");
      });
    });
  }).catch(function(err) {
    console.error("[mirrorverse] Hata:", err.message);
    return [];
  });
}
