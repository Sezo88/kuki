...
var FALLBACK_BASE = "https://www.roketdizi.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["roketdizi"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[roketdizi] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[roketdizi] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "roketdizi");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*roketdizi[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "roketdizi");
      });
    });
  }).catch(function(err) {
    console.error("[roketdizi] Hata:", err.message);
    return [];
  });
}
