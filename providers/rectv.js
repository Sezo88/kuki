...
var FALLBACK_BASE = "https://www.rectv555.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["rectv"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[rectv] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[rectv] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "rectv");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*rectv[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "rectv");
      });
    });
  }).catch(function(err) {
