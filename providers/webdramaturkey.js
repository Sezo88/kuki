// webdramaturkey Provider for Nuvio
...
var FALLBACK_BASE = "https://www.webdramaturkey.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["webdramaturkey"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[webdramaturkey] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[webdramaturkey] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "webdramaturkey");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*webdramaturkey[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "webdramaturkey");
      });
    });
  }).catch(function(err) {
    console.error("[webdramaturkey] Hata:", err.message);
    return [];
  });
}
