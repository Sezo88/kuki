...
var FALLBACK_BASE = "https://sinezy.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["sinezy"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[sinezy] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[sinezy] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "sinezy");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*sinezy[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "sinezy");
      });
    });
  }).catch(function(err) {
    console.error("[sinezy] Hata:", err.message);
    return [];
  });
}
