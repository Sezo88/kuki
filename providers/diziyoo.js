...
var FALLBACK_BASE = "https://www.diziyoo.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["diziyoo"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[diziyoo] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[diziyoo] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "diziyoo");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*diziyoo[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "diziyoo");
      });
    });
  }).catch(function(err) {
    console.error("[diziyoo] Hata:", err.message);
    return [];
  });
}
