...
var FALLBACK_BASE = "https://www.yesilcamtv.mobi";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["yesilcamtv"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[yesilcamtv] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[yesilcamtv] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "yesilcamtv");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*yesilcamtv[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "yesilcamtv");
      });
    });
  }).catch(function(err) {
    console.error("[yesilcamtv] Hata:", err.message);
    return [];
  });
}
