// yabancidizi Provider for Nuvio
...
var FALLBACK_BASE = "https://www.yabancidizi.tv";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["yabancidizi"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[yabancidizi] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[yabancidizi] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "yabancidizi");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*yabancidizi[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "yabancidizi");
      });
    });
  }).catch(function(err) {
    console.error("[yabancidizi] Hata:", err.message);
    return [];
  });
}
