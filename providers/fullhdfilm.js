...
var FALLBACK_BASE = "https://www.fullhdfilm.pro";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["fullhdfilm"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[fullhdfilm] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[fullhdfilm] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "fullhdfilm");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*fullhdfilm[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "fullhdfilm");
      });
    });
  }).catch(function(err) {
    console.error("[fullhdfilm] Hata:", err.message);
    return [];
  });
}
