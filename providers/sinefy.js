...
var FALLBACK_BASE = "https://sinefy.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["sinefy"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[sinefy] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[sinefy] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "sinefy");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*sinefy[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "sinefy");
      });
    });
  }).catch(function(err) {
    console.error("[sinefy] Hata:", err.message);
    return [];
  });
}
