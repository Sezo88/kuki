...
var FALLBACK_BASE = "https://www.dizican.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["dizican"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[dizican] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[dizican] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "dizican");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*dizican[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "dizican");
      });
    });
  }).catch(function(err) {
    console.error("[dizican] Hata:", err.message);
    return [];
  });
}
