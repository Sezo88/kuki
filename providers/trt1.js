...
var FALLBACK_BASE = "https://www.trt1.com.tr";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["trt1"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[trt1] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[trt1] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "trt1");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*trt1[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "trt1");
      });
    });
  }).catch(function(err) {
    console.error("[trt1] Hata:", err.message);
    return [];
  });
}
