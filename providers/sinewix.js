...
var FALLBACK_BASE = "https://www.sinewix.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["sinewix"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[sinewix] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[sinewix] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "sinewix");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*sinewix[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "sinewix");
      });
    });
  }).catch(function(err) {
