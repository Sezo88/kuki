...
var FALLBACK_BASE = "https://golgetv.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["golgetv"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[golgetv] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[golgetv] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "golgetv");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*golgetv[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "golgetv");
      });
    });
  }).catch(function(err) {
    console.error("[golgetv] Hata:", err.message);
    return [];
  });
}
