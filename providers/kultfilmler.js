// kultfilmler Provider for Nuvio
...
var FALLBACK_BASE = "https://kultfilmler.net";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["kultfilmler"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[kultfilmler] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[kultfilmler] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "kultfilmler");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*kultfilmler[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "kultfilmler");
      });
    });
  }).catch(function(err) {
    console.error("[kultfilmler] Hata:", err.message);
    return [];
  });
}
