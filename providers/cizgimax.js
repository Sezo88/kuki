...
var FALLBACK_BASE = "https://www.cizgimax.net";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["cizgimax"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[cizgimax] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[cizgimax] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "cizgimax");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*cizgimax[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "cizgimax");
      });
    });
  }).catch(function(err) {
    console.error("[cizgimax] Hata:", err.message);
    return [];
  });
}
