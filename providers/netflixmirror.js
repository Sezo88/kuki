// netflixmirror Provider for Nuvio
...
var FALLBACK_BASE = "https://netflixmirror.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["netflixmirror"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[netflixmirror] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[netflixmirror] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "netflixmirror");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*netflixmirror[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "netflixmirror");
      });
    });
  }).catch(function(err) {
    console.error("[netflixmirror] Hata:", err.message);
    return [];
  });
}
