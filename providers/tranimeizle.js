// tranimeizle Provider for Nuvio
...
var FALLBACK_BASE = "https://www.tranimeizle.co";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["tranimeizle"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[tranimeizle] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[tranimeizle] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "tranimeizle");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*tranimeizle[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "tranimeizle");
      });
    });
  }).catch(function(err) {
    console.error("[tranimeizle] Hata:", err.message);
    return [];
  });
}
