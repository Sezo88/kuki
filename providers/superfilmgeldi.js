// superfilmgeldi Provider for Nuvio
...
var FALLBACK_BASE = "https://superfilmgeldi.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["superfilmgeldi"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[superfilmgeldi] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[superfilmgeldi] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "superfilmgeldi");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*superfilmgeldi[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "superfilmgeldi");
      });
    });
  }).catch(function(err) {
    console.error("[superfilmgeldi] Hata:", err.message);
    return [];
  });
}
