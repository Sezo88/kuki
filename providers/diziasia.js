...
var FALLBACK_BASE = "https://www.diziasia.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["diziasia"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[diziasia] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[diziasia] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "diziasia");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*diziasia[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "diziasia");
      });
    });
  }).catch(function(err) {
    console.error("[diziasia] Hata:", err.message);
    return [];
  });
}
