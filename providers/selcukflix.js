...
var FALLBACK_BASE = "https://selcukflix.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["selcukflix"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[selcukflix] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[selcukflix] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "selcukflix");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*selcukflix[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "selcukflix");
      });
    });
  }).catch(function(err) {
    console.error("[selcukflix] Hata:", err.message);
    return [];
  });
}
