// cizgivedizi Provider for Nuvio
...
var FALLBACK_BASE = "https://www.cizgivedizi.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["cizgivedizi"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[cizgivedizi] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[cizgivedizi] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "cizgivedizi");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*cizgivedizi[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "cizgivedizi");
      });
    });
  }).catch(function(err) {
    console.error("[cizgivedizi] Hata:", err.message);
    return [];
  });
}
