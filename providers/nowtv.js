...
var FALLBACK_BASE = "https://www.nowtv.com.tr";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["nowtv"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[nowtv] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[nowtv] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "nowtv");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*nowtv[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "nowtv");
      });
    });
  }).catch(function(err) {
    console.error("[nowtv] Hata:", err.message);
    return [];
  });
}
