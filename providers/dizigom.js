...
var FALLBACK_BASE = "https://www.dizigom.bet";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["dizigom"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[dizigom] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[dizigom] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "dizigom");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*dizigom[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "dizigom");
      });
    });
  }).catch(function(err) {
