...
var FALLBACK_BASE = "https://animecix.net";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["animecix"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[animecix] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[animecix] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "animecix");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*animecix[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "animecix");
      });
    });
  }).catch(function(err) {
