...
var FALLBACK_BASE = "https://yeniwatch.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["yenwatch"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[yenwatch] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[yenwatch] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "yenwatch");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*yenwatch[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "yenwatch");
      });
    });
  }).catch(function(err) {
    console.error("[yenwatch] Hata:", err.message);
    return [];
  });
}
