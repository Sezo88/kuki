...
var FALLBACK_BASE = "https://www.asyafilmizlesene.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["asya_film"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[asya_film] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[asya_film] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "asya_film");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*asya[_-]?film[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "asya_film");
      });
    });
  }).catch(function(err) {
    console.error("[asya_film] Hata:", err.message);
    return [];
  });
}
