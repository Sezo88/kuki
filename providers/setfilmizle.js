// setfilmizle Provider for Nuvio
...
var FALLBACK_BASE = "https://www.setfilmizle.mobi";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["setfilmizle"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[setfilmizle] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[setfilmizle] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "setfilmizle");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*setfilmizle[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "setfilmizle");
      });
    });
  }).catch(function(err) {
    console.error("[setfilmizle] Hata:", err.message);
    return [];
  });
}
