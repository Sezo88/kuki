...
var FALLBACK_BASE = "https://www.dizilla.club";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["dizilla"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[dizilla] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[dizilla] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "dizilla");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*dizilla[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "dizilla");
      });
    });
  }).catch(function(err) {
    console.error("[dizilla] Hata:", err.message);
    return [];
  });
}
