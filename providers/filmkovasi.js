...
var FALLBACK_BASE = "https://www.filmkovasi.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["filmkovasi"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[filmkovasi] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[filmkovasi] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "filmkovasi");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*filmkovasi[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "filmkovasi");
      });
    });
  }).catch(function(err) {
    console.error("[filmkovasi] Hata:", err.message);
    return [];
  });
}
