...
var FALLBACK_BASE = "https://www.dizimag.net";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["dizimag"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[dizimag] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[dizimag] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "dizimag");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*dizimag[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "dizimag");
      });
    });
  }).catch(function(err) {
    console.error("[dizimag] Hata:", err.message);
    return [];
  });
}
