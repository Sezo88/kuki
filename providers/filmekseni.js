...
var FALLBACK_BASE = "https://www.filmekseni.net";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["filmekseni"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[filmekseni] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[filmekseni] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "filmekseni");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*filmekseni[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "filmekseni");
      });
    });
  }).catch(function(err) {
    console.error("[filmekseni] Hata:", err.message);
    return [];
  });
}
