// trdizi_izle Provider for Nuvio
...
var FALLBACK_BASE = "https://trdiziizle.net";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["trdizi_izle"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[trdizi_izle] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[trdizi_izle] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "trdizi_izle");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*trdizi[_-]?izle[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "trdizi_izle");
      });
    });
  }).catch(function(err) {
    console.error("[trdizi_izle] Hata:", err.message);
    return [];
  });
}
