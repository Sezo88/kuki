...
var FALLBACK_BASE = "https://www.tvdiziler.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["tvdiziler"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[tvdiziler] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[tvdiziler] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "tvdiziler");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*tvdiziler[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "tvdiziler");
      });
    });
  }).catch(function(err) {
    console.error("[tvdiziler] Hata:", err.message);
    return [];
  });
}
