// sezonlukdizi Provider for Nuvio
...
var FALLBACK_BASE = "https://www.sezonlukdizi.mobi";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["sezonlukdizi"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[sezonlukdizi] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[sezonlukdizi] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "sezonlukdizi");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*sezonlukdizi[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "sezonlukdizi");
      });
    });
  }).catch(function(err) {
