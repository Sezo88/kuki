// filmmakinesi Provider for Nuvio
...
var FALLBACK_BASE = "https://www.filmmakinesi.mobi";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["filmmakinesi"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[filmmakinesi] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[filmmakinesi] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "filmmakinesi");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*filmmakinesi[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "filmmakinesi");
      });
    });
  }).catch(function(err) {
    console.error("[filmmakinesi] Hata:", err.message);
    return [];
  });
}
