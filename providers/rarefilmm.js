...
var FALLBACK_BASE = "https://rarefilmm.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["rarefilmm"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[rarefilmm] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[rarefilmm] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "rarefilmm");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*rarefilmm[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "rarefilmm");
      });
    });
  }).catch(function(err) {
    console.error("[rarefilmm] Hata:", err.message);
    return [];
  });
}
