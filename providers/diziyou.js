...
var FALLBACK_BASE = "https://www.diziyou.co";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["diziyou"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[diziyou] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[diziyou] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "diziyou");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*diziyou[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "diziyou");
      });
    });
  }).catch(function(err) {
