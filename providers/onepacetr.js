...
var FALLBACK_BASE = "https://onepace.net";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["onepacetr"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[onepacetr] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[onepacetr] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "onepacetr");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*onepacetr[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "onepacetr");
      });
    });
  }).catch(function(err) {
    console.error("[onepacetr] Hata:", err.message);
    return [];
  });
}
