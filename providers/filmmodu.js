...
var FALLBACK_BASE = "https://www.filmmodu.biz";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["filmmodu"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[filmmodu] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[filmmodu] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "filmmodu");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*filmmodu[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "filmmodu");
      });
    });
  }).catch(function(err) {
