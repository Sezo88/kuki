...
var FALLBACK_BASE = "https://wfilmizle.net";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["wfilmizle"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[wfilmizle] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[wfilmizle] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "wfilmizle");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*wfilmizle[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "wfilmizle");
      });
    });
  }).catch(function(err) {
