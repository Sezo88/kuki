...
var FALLBACK_BASE = "https://www.dizipal.video";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["dizipal"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[dizipal] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[dizipal] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "dizipal");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*dizipal[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "dizipal");
      });
    });
  }).catch(function(err) {
