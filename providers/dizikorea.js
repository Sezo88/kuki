...
var FALLBACK_BASE = "https://www.dizikorea.biz";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["dizikorea"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[dizikorea] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[dizikorea] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "dizikorea");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*dizikorea[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "dizikorea");
      });
    });
  }).catch(function(err) {
    console.error("[dizikorea] Hata:", err.message);
    return [];
  });
}
