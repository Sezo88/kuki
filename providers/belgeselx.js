...
var FALLBACK_BASE = "https://www.belgeselx.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["belgeselx"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[belgeselx] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[belgeselx] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "belgeselx");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*belgeselx[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "belgeselx");
      });
    });
  }).catch(function(err) {
    console.error("[belgeselx] Hata:", err.message);
    return [];
  });
}
