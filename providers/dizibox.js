...
var FALLBACK_BASE = "https://www.dizibox.mobi";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["dizibox"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[dizibox] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[dizibox] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "dizibox");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*dizibox[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "dizibox");
      });
    });
  }).catch(function(err) {
