...
var FALLBACK_BASE = "https://www.birasyamizi.com";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["asyadizi"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[asyadizi] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[asyadizi] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "asyadizi");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*asyadizi[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "asyadizi");
      });
    });
  }).catch(function(err) {
    console.error("[asyadizi] Hata:", err.message);
    return [];
  });
}
