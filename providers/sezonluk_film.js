// sezonluk_film Provider for Nuvio
...
var FALLBACK_BASE = "https://sezonlukfilm.net";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["sezonluk_film"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[sezonluk_film] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[sezonluk_film] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "sezonluk_film");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*sezonluk[_-]?film[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "sezonluk_film");
      });
    });
  }).catch(function(err) {
    console.error("[sezonluk_film] Hata:", err.message);
    return [];
  });
}
