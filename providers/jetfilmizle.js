// jetfilmizle Provider for Nuvio
...
var FALLBACK_BASE = "https://jetfilmizle.net";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["jetfilmizle"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[jetfilmizle] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[jetfilmizle] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "jetfilmizle");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*jetfilmizle[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "jetfilmizle");
      });
    });
  }).catch(function(err) {
    console.error("[jetfilmizle] Hata:", err.message);
    return [];
  });
}
