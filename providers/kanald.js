...
var FALLBACK_BASE = "https://www.kanald.com.tr";

function _getBaseUrl() {
  return fetch(CONFIG_URL)
    .then(function(r) { return r.json(); })
    .then(function(cfg) {
      var p = cfg.providers && cfg.providers["kanald"];
...
function getStreams(tmdbId, mediaType, season, episode) {
  var label = mediaType === "tv"
    ? "[kanald] S" + season + "E" + episode + " tmdb:" + tmdbId
    : "[kanald] tmdb:" + tmdbId;
  console.log(label);
  ...
  return _getBaseUrl().then(function(base) {
    ...
    .then(function(html) {
      var streams = _parseStreams(html, "kanald");

      // İçerik sayfasına gitmek için ilk post linkini bul
      var linkRe = /href=["'](https?:\/\/[^"']*kanald[^"']+)["']/i;
      ...
      .then(function(html2) {
        return _parseStreams(html2, "kanald");
      });
    });
  }).catch(function(err) {
    console.error("[kanald] Hata:", err.message);
    return [];
  });
}
